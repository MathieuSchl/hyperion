...
module.exports.run = async (bot, message, teamData) => {
    ...
    electricalEmbed.setDescription("Dysfonctionnement du module d'alimentation du réacteur\n" +
        "Veuillez recalibrer le sytème en activant les différents modules d'énergie\n" +
        "Le réacteur à besoin de `" + dmData["Reactor"].end + "` unités d'énergie pour fonctionner\n" +
    ...
    for (let i = 0; i < length; i++) {
        ...
        mpChanel.send("Activation du réacteur en cours\n" +
                "Le réacteur a besoin de `" + dmData["Reactor"].end + "` unités d'énergie pour fonctionner\n" +
