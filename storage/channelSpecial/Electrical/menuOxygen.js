...
module.exports.run = async (bot, message, teamData) => {
    ...
    electricalEmbed.setDescription("Dysfonctionnement du module d'alimentation du système d'oxygène\n" +
    ...
    for (let i = 0; i < length; i++) {
        ...
        mpChanel.send("Activation du système à oxygène en cours\n" +
                "Le système a oxygène à besoin de `" + dmData[system].end + "` unités d'énergie pour fonctionner\n" +
